...
namespace KoiVM.Runtime.Execution.Internal {
	internal static class DirectCall {
		static Hashtable directProxies = new Hashtable();
		static Hashtable typedProxies = new Hashtable();
		static Hashtable constrainedProxies = new Hashtable();
		static MethodInfo refToTypedRef;
		static MethodInfo castTypedRef;
		static ConstructorInfo newTypedRef;
