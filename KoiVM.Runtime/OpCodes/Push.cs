...
namespace KoiVM.Runtime.OpCodes {
	internal class PushRByte : IOpCode {
		public byte Code {
			get { return Constants.OP_PUSHR_BYTE; }
		}
	...
	internal class PushRWord : IOpCode {
		public byte Code {
			get { return Constants.OP_PUSHR_WORD; }
		}
	...
	internal class PushRDword : IOpCode {
		public byte Code {
			get { return Constants.OP_PUSHR_DWORD; }
		}
	...
	internal class PushRQword : IOpCode {
		public byte Code {
			get { return Constants.OP_PUSHR_QWORD; }
		}
	...
	internal class PushRObject : IOpCode {
		public byte Code {
			get { return Constants.OP_PUSHR_OBJECT; }
		}
	...
	internal class PushIDword : IOpCode {
		public byte Code {
			get { return Constants.OP_PUSHI_DWORD; }
		}
	...
	internal class PushIQword : IOpCode {
		public byte Code {
			get { return Constants.OP_PUSHI_QWORD; }
		}
