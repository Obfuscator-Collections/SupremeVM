...
namespace KoiVM.Runtime.OpCodes {
	internal class DivDword : IOpCode {
		public byte Code {
			get { return Constants.OP_DIV_DWORD; }
		}
	...
	internal class DivQword : IOpCode {
		public byte Code {
			get { return Constants.OP_DIV_QWORD; }
		}
	...
	internal class DivR32 : IOpCode {
		public byte Code {
			get { return Constants.OP_DIV_R32; }
		}
		...
		public void Run(VMContext ctx, out ExecutionState state) {
			...
			byte mask = (byte)(Constants.FL_ZERO | Constants.FL_SIGN);
	...
	internal class DivR64 : IOpCode {
		public byte Code {
			get { return Constants.OP_DIV_R64; }
		}
