...
namespace KoiVM.Runtime.OpCodes {
	internal class FConvR32 : IOpCode {
		public byte Code {
			get { return Constants.OP_FCONV_R32; }
		}
	...
	internal class FConvR64 : IOpCode {
		public byte Code {
			get { return Constants.OP_FCONV_R64; }
		}
		...
		public void Run(VMContext ctx, out ExecutionState state) {
			...
			byte fl = ctx.Registers[Constants.REG_FL].U1;
	...
	internal class FConvR32R64 : IOpCode {
		public byte Code {
			get { return Constants.OP_FCONV_R32_R64; }
		}
	...
	internal class FConvR64R32 : IOpCode {
		public byte Code {
			get { return Constants.OP_FCONV_R64_R32; }
		}
